...
func (h *Handler) InitRouters() *gin.Engine {
	...
	privateAnalytics.Use(h.authMiddleware.Handle())
	{
		...
		privateAnalytics.POST("/operations/latency", h.analyticsHandler.OperationalLatency)
		privateAnalytics.POST("/dispatch/failures", h.analyticsHandler.DispatchFailures)
		privateAnalytics.POST("/brigades/workload", h.analyticsHandler.BrigadeWorkload)
		privateAnalytics.POST("/workers/active", h.analyticsHandler.ActiveWorkers)
		privateAnalytics.POST("/dispatch/funnel", h.analyticsHandler.AssignmentFunnel)
		privateAnalytics.POST("/dispatch/effectiveness", h.analyticsHandler.DispatchEffectiveness)
		privateAnalytics.POST("/operations/insights", h.analyticsHandler.OperationalInsights)
	...
	privateAssets.Use(h.authMiddleware.Handle())
	{
		...
		privateAssets.POST("/resolve", h.assetHandler.Resolve)
