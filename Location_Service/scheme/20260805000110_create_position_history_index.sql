...
CREATE UNIQUE INDEX position_history_event_id_uidx ON position_history(event_id);
CREATE UNIQUE INDEX position_history_device_sequence_uidx ON position_history(device_id, sequence);
