...
('$ticketDone','$depRoads','$residentId','$brigadeRoad','Яма на дороге устранена','Восстановлено асфальтовое покрытие во дворе.','$catRoad','HIGH','DONE','Петровка, 22',55.7665,37.6178,now()-interval '2 days',now()-interval '1 day',now()-interval '46 hours',now()-interval '1 day',NULL),
...
('$ticketCanceled','$depRoads','$residentId',NULL,'Ветка на проезжей части','Объект уже убран другой службой.','$catRoad','LOW','CANCELED','Чистопрудный бульвар, 9',55.7631,37.6385,now()-interval '3 days',now()-interval '2 days',NULL,NULL,now()-interval '2 days')
